    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          ...
          <form action="index.php?page=login" method="post" class="sign-in-form">
            ...
            <?php if (isset($_SESSION['login_error'])) { ?>
                ...
                <?php unset($_SESSION['login_error']); ?> <!-- Clear the message after it's displayed -->
            <?php } ?>
          ...
          <!-- Dăng ký -->
          <form action="index.php?page=login" method="post" class="sign-up-form"> 
            ...
            <?php if (isset($_SESSION['singup_error'])) { ?>
                <div class="message"><?php echo $_SESSION['singup_error']; ?></div>
                <?php unset($_SESSION['singup_error']); ?> <!-- Clear the message after it's displayed -->
            <?php } ?>
